...
$('#update_cake').on('click', function(){
	$('#form_update_cake').validate({ ignore : [] });
    
	var form = new FormData($("#form_update_cake")[0]);
...
$("#cake_category option").each(function()
{
    if($(this).val() == $('#current_cake_category').val())
    {
