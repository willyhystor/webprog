...
$('#update_profile').on('click', function(){
	...
	var form = new FormData($("#form_profile")[0]);
    ...
    if($('#customer_password').val() != '' || $('#customer_password_confirmation').val() != '')
    {
